...
df = pd.read_csv('C:/xampp/htdocs/empowerher_hub/fitness_webapp/heart_data.csv')
print(df.head())
...
import pickle
pickle.dump(model, open('C:/xampp/htdocs/empowerher_hub/fitness_webapp/models/model.pkl','wb'))

model = pickle.load(open('C:/xampp/htdocs/empowerher_hub/fitness_webapp/models/model.pkl','rb'))
